...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(GraphicsObjectsUtils.select(document, new Point(1,1), 8).size() == 1);
        assertTrue(GraphicsObjectsUtils.select(document, new Point(1,1), 8).firstElement().getID() == c.getID());
    }
    ...
    public void testSelect2() throws Exception {
        ...
        assertTrue(GraphicsObjectsUtils.select(document, new Point(1,1), 8).size() == 2);
    }
    ...
    public void testConstructorGrid() throws Exception {
        Document document = DocumentFactory.createGrilleCarre(new Point(0,0), 3, 3, 5);
    ...
    public void testConstructorCircle() throws Exception {
        Document document = DocumentFactory.createCerclesConcentriques(new Point(0,0), 4, 3., 4.);
